...
namespace ExploraProp.Asset.ApiClient.Models
{
    ...
    public partial class PaginatedResultOfPropertyDto : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ExploraProp.Asset.ApiClient.Models.PropertyDto>? Items { get; set; }
#nullable restore
#else
        public List<global::ExploraProp.Asset.ApiClient.Models.PropertyDto> Items { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ExploraProp.Asset.ApiClient.Models.PaginatedResultOfPropertyDto"/> and sets the default values.
        /// </summary>
        public PaginatedResultOfPropertyDto()
        {
        ...
        public static global::ExploraProp.Asset.ApiClient.Models.PaginatedResultOfPropertyDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::ExploraProp.Asset.ApiClient.Models.PaginatedResultOfPropertyDto();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "items", n => { Items = n.GetCollectionOfObjectValues<global::ExploraProp.Asset.ApiClient.Models.PropertyDto>(global::ExploraProp.Asset.ApiClient.Models.PropertyDto.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ExploraProp.Asset.ApiClient.Models.PropertyDto>("items", Items);
